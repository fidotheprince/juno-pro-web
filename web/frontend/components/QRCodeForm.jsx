...
export function QRCodeForm({ QRCode: InitialQRCode }) {
  ...
  const [value, setValue] = useState(0); //used to add customer points;
  ...
  //onSubmit is a function that takes the form data and sends it to the API it handles QR code creation and updates
  ...
  */
  ...
  /*
   This function is used to handle adding reward points to the QR code
   */
  const handleRewardPoints = useCallback(points => setValue(points), []);
