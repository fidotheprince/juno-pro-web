...
export default function QRCodeEdit() {
    ...
    //example endpoint: https://juno-merchants.myshopify.com/apps/juno-solutions-app/qrcodes/1
  ...
  /*
    ...
    This happens upon the initial page load, so the QR code is available
  */
  const {
    data: QRCode,
    isLoading,
